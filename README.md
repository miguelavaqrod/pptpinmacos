...
```
sudo vi /etc/ppp/peers/PPTP_DOMAIN_YOU_WANT_TO_CONNECT_TO_OR_WHATEVER_NAME_YOU_CHOOSE
```
...
```
sudo chmod 640 /etc/ppp/peers/PPTP_DOMAIN_I_WANT_TO_CONNECT_TO_OR_WHATEVER_NAME_YOU_CHOOSE
```
